...
// The view and proj matrices below make-up the camera position, orientation,
// fov, etc. The model matrices moves your surface of revolution to the world
// coordinate system
...
// Forward Declaration
// this function loads a .jpg or .png file into a previously activated texture
// map
...
int main(int argc, char* argv[]) {
  if (argc < 4) {
    printf(
        "\nEnter atleast 3 filenames to run this program: (1) vtx_shader, (2) "
        "frag_shader, (3) texture_1\n");
    printf("\nQuiting now...\n");
  ...
  GLuint shader_programme = create_programme_from_files(argv[1], argv[2]);
  ...
  /*---------------------------SET RENDERING
   * DEFAULTS---------------------------*/
  // The model matrix stores the position and orientation transformations for
  // your SoR
  ...
  glClearColor(0.1, 0.1, 0.1,
               1.0);  // non-black background to help spot mistakes
